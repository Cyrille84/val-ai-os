...
const DEFAULT_AGENTS: Agent[] = [
  ...
  id: "meta-agent",
  name: "Meta-Agent Val",
  description: "L'architecte de Val AI OS. Concoit l'architecture complete de tout agent en 7 etapes.",
  status: "idle",
  type: "coordinator",
  model: "claude-sonnet-4-6",
  tasksCompleted: 0,
  instructions: "Identifier le type d'agent, definir le workflow, produire les System Prompts.",
},
